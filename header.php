...
<!-- 
	<div id="wocky-offcanvas">
		...
		<h3 class="wocky-lead">Connect with us</h3>
		<p class="wocky-social-icons">
	...
	<div id="wocky-menu" class="navbar">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<a href="#" class="js-wocky-nav-toggle wocky-nav-toggle" data-toggle="collapse" data-target="#wocky-navbar" aria-expanded="false" aria-controls="navbar"><span>Menu</span> <i></i></a>
	...
	<div id="wocky-page">
		<div id="wocky-wrap">
			...
			<header id="hero" data-section="home" role="banner">
				<div class="canvas-wrapper bg-brand-dk">

				    <canvas id="particle-field" class="background"></canvas>
				    <canvas id="wocky-text" class="foreground"></canvas>
				    <canvas id="wocky-shape" class="foreground"></canvas>
				...
				<div class="nav-container nav-desktop">
	                <a class="navbar-brand" href="#home" data-nav-section="home">
	                    <svg width="158" height="84" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
	                        <image x="0" y="0" width="158" height="84" xlink:href="<?= get_template_directory_uri() ?>/assets/img/logo-nav-wocky.svg"></image>
	                    </svg>
	                </a>
			        <nav>
						<ul class="nav" role="navigation">
							...
							<li><a href="#contact" data-nav-section="contact">contact</span></a></li>
						</ul>
					</nav>
				</div>
			</header>
